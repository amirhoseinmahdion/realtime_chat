    ...
    schemas: {
      User: {
        ...
        properties: {
          ...
          bio: { type: "string" },
          avatarUrl: { type: ["string", "null"], description: "HTTP(S) URL or a validated PNG, JPEG, WebP, or GIF data URL up to 500 KB." },
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  avatarUrl: { type: ["string", "null"], maxLength: 684000 },
                },
              },
            },
          },
