...
const persian: Record<string, string> = {
  ...
  "Avatar images must be 2 MB or smaller.": "حجم تصویر پروفایل باید ۲ مگابایت یا کمتر باشد.",
  ...
  "Choose a PNG, JPG, WebP, or GIF image up to 2 MB.": "یک تصویر PNG، JPG، WebP یا GIF تا حجم ۲ مگابایت انتخاب کنید.",
